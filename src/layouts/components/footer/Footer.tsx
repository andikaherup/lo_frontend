        ...
        <div className='container px-6 m-auto space-y-8 text-gray-600 dark:text-gray-400 md:px-12 lg:px-20'>
          <div className='grid grid-cols-8 gap-6 md:gap-0'>
            ...
            <div className='col-span-8 md:col-span-6 lg:col-span-5'>
              <div className='grid grid-cols-2 gap-6 pb-5 sm:grid-cols-3 md:pl-16'>
                <div>
                  <h6 className='text-lg font-medium text-black-500 dark:text-black-500'>Level 0</h6>
                  <ul className='mt-4 space-y-4 list-inside'>
                    <li>
                      <a href='/tnc' className='transition hover:text-cyan-600'>
                        Terms & Condition
                      </a>
                    </li>
                    <li>
                      <a href='/privacy-policy' className='transition hover:text-cyan-600'>
                        Privacy Policy
                      </a>
                    </li>
                    <li>
              ...
              <div className='flex justify-between py-1 pb-8 border-t border-gray-100 dark:border-gray-800 md:pl-16'>
