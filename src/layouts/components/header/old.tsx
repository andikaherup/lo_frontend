      ...
      >
        <nav className='grid grid-flow-col px-6 py-3 mx-auto sm:px-8 lg:px-16 sm:py-4'>
          <div className='flex items-center col-start-1 col-end-2'>
            <Image src='/images/favicon.png' alt='Image 1' quality={100} width={30} height={30} />
            SOFTWARE
          </div>
          <ul className='items-center hidden col-start-4 col-end-8 lg:flex text-black-500'>
            <LinkScroll
              ...
              className={
                ...
                (activeLink === 'about' ? ' text-blue-500 animation-active ' : ' text-black-500 hover:text-blue-500 a')
              }
            >
              Personality Test
            </LinkScroll>
            <LinkScroll
              ...
              className={
                'px-4 py-2 mx-2 cursor-pointer animation-hover inline-block relative' +
                (activeLink === 'feature' ? ' text-blue-500 animation-active ' : ' text-black-500 hover:text-blue-500 ')
              }
            >
              Personality Types
            </LinkScroll>
            <LinkScroll
              ...
              className={
                'px-4 py-2 mx-2 cursor-pointer animation-hover inline-block relative' +
                (activeLink === 'pricing' ? ' text-blue-500 animation-active ' : ' text-black-500 hover:text-blue-500 ')
              }
            >
              Specialized Test
            </LinkScroll>
          ...
          <div className='flex items-center justify-end col-start-10 col-end-12 font-medium'>
            ...
            <ButtonOutline>Take Personality Test</ButtonOutline>
          </div>
        </nav>
      </header>
      {/* Mobile Navigation */}
          ...
          <ul className='flex items-center justify-between w-full text-black-500'>
            <LinkScroll
              ...
              className={
                ...
                (activeLink === 'about' ? '  border-orange-500 text-orange-500' : ' border-transparent')
              }
            >
              <svg
                className='w-6 h-6'
            ...
            <LinkScroll
              ...
              className={
                'mx-1 sm:mx-2 px-3 sm:px-4 py-2 flex flex-col items-center text-xs border-t-2 transition-all ' +
                (activeLink === 'feature' ? '  border-orange-500 text-orange-500' : ' border-transparent ')
              }
            >
              <svg
                className='w-6 h-6'
            ...
            <LinkScroll
              ...
              className={
                'mx-1 sm:mx-2 px-3 sm:px-4 py-2 flex flex-col items-center text-xs border-t-2 transition-all ' +
                (activeLink === 'pricing' ? '  border-orange-500 text-orange-500' : ' border-transparent ')
              }
            >
              <svg
                className='w-6 h-6'
            ...
            <LinkScroll
              ...
              className={
                'mx-1 sm:mx-2 px-3 sm:px-4 py-2 flex flex-col items-center text-xs border-t-2 transition-all ' +
                (activeLink === 'testimoni' ? '  border-orange-500 text-orange-500' : ' border-transparent ')
              }
            >
              <svg
                className='w-6 h-6'
