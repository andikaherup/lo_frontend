          ...
          <div className='grid grid-flow-row gap-8 py-6 sm:grid-flow-col md:grid-rows-1 sm:py-16'>
            <div className='flex flex-col items-start justify-start row-start-2 lg:px-20 sm:row-start-1'>
              ...
              <p className='mt-4 mb-6 text-black-500'>
                ...
                <p>
                  This website is operated by Next Level Academy. Throughout the site, the terms &ldquo;we&rdquo;,
                  &ldquo;us&rdquo; and &ldquo;our&rdquo; refer to Next Level Academy. &nbsp;Next Level Academy offers
                ...
                <p>
                  By visiting our site and/ or purchasing something from us, you engage in our &ldquo;Service&rdquo; and
                  agree to be bound by the following terms and conditions (&ldquo;Terms of Service&rdquo;,
                  &ldquo;Terms&rdquo;), including those additional terms and conditions and policies referenced herein
                  and/or available by hyperlink. These Terms of Service apply to all users of the site, including
                  without limitation users who are browsers, vendors, customers, merchants, and/ or contributors of
                  content.
                </p>
                <p>
                  <br />
                ...
                <p>
                  Our store is hosted on Next Level Academy. They provide us with the online e-commerce platform that
                  allows us to promote and sell our products and services to you.
                </p>
                <p>
                  <br />
                </p>
                ...
                <p>
                  ...
                  or services may have limited quantities and are subject to refund or exchange only according to our
                  Refund Policy.
                </p>
                <p>
                  ...
                  of products or product pricing are subject to change at any time without notice, at the sole
                ...
                <p>
                  You acknowledge and agree that we provide access to such tools &rdquo;as is&rdquo; and &ldquo;as
                ...
                <p>
                  ...
                  and you should ensure that you are familiar with and approve of the terms on which tools are provided
                ...
                <p>
                  ...
                  review carefully the third-party&apos;s policies and practices and make sure you understand them
                ...
                <p>
                  ...
                  otherwise objectionable or violates any party&rsquo;s intellectual property or these Terms of Service.
                </p>
                <p>
                ...
                <p>
                  ...
                  offers, transit times and availability. We reserve the right to correct any errors, inaccuracies or
                  omissions, and to change or update information or cancel orders if any information in the Service or
                  on any related website is inaccurate at any time without prior notice (including after you have
                ...
                <p>
                  In no case shall Next Level Academy, our directors, officers, employees, affiliates, agents,
                  ...
                  or otherwise made available via the service, even if advised of their possibility. Because some states
                  or jurisdictions do not allow the exclusion or the limitation of liability for consequential or
                ...
                <p>
                  You agree to indemnify, defend and hold harmless to Next Level Academy and our parent, subsidiaries,
                  ...
                  reasonable attorneys&rsquo; fees, made by any third-party due to or arising out of your breach of
                ...
                <p>
                  ...
                  The Service constitutes the entire agreement and understanding between you and us and govern your use
                ...
                <p>
                  Questions about the Terms of Service should be sent to us at Level0, Next Level Academy (
                  <a href='about%3Ablank'>hello@</a>thel0.com).
                </p>
              </p>
            </div>
          </div>
...
Tnc.getLayout = (page: ReactNode) => <BlankLayoutLandingPage>{page}</BlankLayoutLandingPage>
